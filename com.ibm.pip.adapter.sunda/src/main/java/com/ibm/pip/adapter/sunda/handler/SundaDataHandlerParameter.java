...
public class SundaDataHandlerParameter extends BaseEasHandlerParameter {

	public SundaDataHandlerParameter() throws EsbException {
		super();
	}
	 ...
	 */
	public static final String EVENTAPPSSERV_HANDLER = "SundaDataHandlerPool.HandlerNum";
	
	public static final String STOP_WAIT_TIME = "SundaDataHandlerPool.StopWaitTime";
	
	public static final String Handler_ClassName = "SundaDataHandlerPool.HandlerClassName";
